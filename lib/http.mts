...
export const COLS = ["id", "artist", "title", "album", "genre", "year", "comments", "label", "bpm", "key", "plays", "rating", "added", "bitrate", "time", "kind"];
...
export async function readTracks(req) {
  ...
  const num = new Set(["bpm", "plays", "rating", "bitrate", "time"]);
